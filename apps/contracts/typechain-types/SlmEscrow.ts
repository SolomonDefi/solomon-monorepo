...
export interface SlmEscrowInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "party1Evidence",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "party1EvidenceURL",
    values?: undefined
  ): string;
  encodeFunctionData(functionFragment: "party2", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "party2Evidence",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "party2EvidenceURL",
    values?: undefined
  ): string;
...
export interface SlmEscrow extends BaseContract {
