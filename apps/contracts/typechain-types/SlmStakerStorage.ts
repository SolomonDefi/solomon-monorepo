...
export interface SlmStakerStorageInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "addressLookup",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getVoteEndTime",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "unstakePeriod",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SlmStakerStorage extends BaseContract {
